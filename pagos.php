 ...
 */
    ...
    class pagosPage extends Page
    {
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_pagos_id_tramite_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('id_tramite', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_pagos_id_tramite_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_pagos_usuario_registro_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('usuario_registro', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_pagos_usuario_registro_search');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('Id Tramite', 'id_tramite', 'id_tramite_id_tramite', 'edit_pagos_id_tramite_search', $editor, $this->dataset, $lookupDataset, 'id_tramite', 'id_tramite', '');
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('id_tramite', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Tramite', 'id_tramite', 'id_tramite_id_tramite', 'multi_edit_pagos_id_tramite_search', $editor, $this->dataset, $lookupDataset, 'id_tramite', 'id_tramite', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('id_tramite', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Tramite', 'id_tramite', 'id_tramite_id_tramite', 'insert_pagos_id_tramite_search', $editor, $this->dataset, $lookupDataset, 'id_tramite', 'id_tramite', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Registrado por:', 'usuario_registro', 'usuario_registro_nombres', 'insert_pagos_usuario_registro_search', $editor, $this->dataset, $lookupDataset, 'id_usuario', 'nombres', '');
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('id_tramite', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_pagos_id_tramite_search', 'id_tramite', 'id_tramite', null, 20);
            ...
            $lookupDataset->setOrderByField('nombres', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_pagos_usuario_registro_search', 'id_usuario', 'nombres', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('id_tramite', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_pagos_id_tramite_search', 'id_tramite', 'id_tramite', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nombres', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_pagos_usuario_registro_search', 'id_usuario', 'nombres', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('id_tramite', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_pagos_id_tramite_search', 'id_tramite', 'id_tramite', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('id_tramite', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_pagos_id_tramite_search', 'id_tramite', 'id_tramite', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    try
    {
        $Page = new pagosPage("pagos", "pagos.php", GetCurrentUserPermissionsForPage("pagos"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("pagos"));
