 ...
 */
    ...
    class seguimiento_etapasPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Seguimiento de Etapas');
            $this->SetMenuLabel('Seguimiento de Etapas');
            ...
            $this->dataset->AddLookupField('id_etapa', 'etapas_tramite', new IntegerField('id_etapa'), new StringField('nombre', false, false, false, false, 'id_etapa_nombre', 'id_etapa_nombre_etapas_tramite'), 'id_etapa_nombre_etapas_tramite');
        ...
        {
            return array(
                new FilterColumn($this->dataset, 'id_seguimiento', 'id_seguimiento', 'Id'),
                new FilterColumn($this->dataset, 'id_tramite', 'id_tramite_id_tramite', 'Id Tramite'),
                new FilterColumn($this->dataset, 'id_etapa', 'id_etapa_nombre', 'Etapa'),
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_seguimiento_etapas_id_tramite_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('id_tramite', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_seguimiento_etapas_id_tramite_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_seguimiento_etapas_id_etapa_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('id_etapa', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_seguimiento_etapas_id_etapa_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_seguimiento_etapas_id_estado_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('id_estado', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_seguimiento_etapas_id_estado_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_seguimiento_etapas_usuario_registro_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('usuario_registro', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_seguimiento_etapas_usuario_registro_search');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            $column = new NumberViewColumn('id_seguimiento', 'id_seguimiento', 'Id', $this->dataset);
            ...
            //
            $column = new TextViewColumn('id_etapa', 'id_etapa_nombre', 'Etapa', $this->dataset);
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            //
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('Id Tramite', 'id_tramite', 'id_tramite_id_tramite', 'edit_seguimiento_etapas_id_tramite_search', $editor, $this->dataset, $lookupDataset, 'id_tramite', 'id_tramite', '');
            ...
            $editColumn = new DynamicLookupEditColumn('Etapa', 'id_etapa', 'id_etapa_nombre', 'edit_seguimiento_etapas_id_etapa_search', $editor, $this->dataset, $lookupDataset, 'id_etapa', 'nombre', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('nombre', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Estado', 'id_estado', 'id_estado_nombre', 'edit_seguimiento_etapas_id_estado_search', $editor, $this->dataset, $lookupDataset, 'id_estado', 'nombre', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('id_tramite', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Tramite', 'id_tramite', 'id_tramite_id_tramite', 'multi_edit_seguimiento_etapas_id_tramite_search', $editor, $this->dataset, $lookupDataset, 'id_tramite', 'id_tramite', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            ...
            $lookupDataset->setOrderByField('nombre', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Etapa', 'id_etapa', 'id_etapa_nombre', 'multi_edit_seguimiento_etapas_id_etapa_search', $editor, $this->dataset, $lookupDataset, 'id_etapa', 'nombre', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('nombre', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Estado', 'id_estado', 'id_estado_nombre', 'multi_edit_seguimiento_etapas_id_estado_search', $editor, $this->dataset, $lookupDataset, 'id_estado', 'nombre', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('id_tramite', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Tramite', 'id_tramite', 'id_tramite_id_tramite', 'insert_seguimiento_etapas_id_tramite_search', $editor, $this->dataset, $lookupDataset, 'id_tramite', 'id_tramite', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            ...
            $lookupDataset->setOrderByField('nombre', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Etapa', 'id_etapa', 'id_etapa_nombre', 'insert_seguimiento_etapas_id_etapa_search', $editor, $this->dataset, $lookupDataset, 'id_etapa', 'nombre', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('nombre', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Estado', 'id_estado', 'id_estado_nombre', 'insert_seguimiento_etapas_id_estado_search', $editor, $this->dataset, $lookupDataset, 'id_estado', 'nombre', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Registrado por:', 'usuario_registro', 'usuario_registro_nombre_completo', 'insert_seguimiento_etapas_usuario_registro_search', $editor, $this->dataset, $lookupDataset, 'id_usuario', 'nombre_completo', '');
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('id_tramite', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_seguimiento_etapas_id_tramite_search', 'id_tramite', 'id_tramite', null, 20);
            ...
            $lookupDataset->setOrderByField('nombre', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_seguimiento_etapas_id_etapa_search', 'id_etapa', 'nombre', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nombre', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_seguimiento_etapas_id_estado_search', 'id_estado', 'nombre', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nombre_completo', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_seguimiento_etapas_usuario_registro_search', 'id_usuario', 'nombre_completo', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('id_tramite', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_seguimiento_etapas_id_tramite_search', 'id_tramite', 'id_tramite', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nombre', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_seguimiento_etapas_id_etapa_search', 'id_etapa', 'nombre', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nombre', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_seguimiento_etapas_id_estado_search', 'id_estado', 'nombre', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nombre_completo', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_seguimiento_etapas_usuario_registro_search', 'id_usuario', 'nombre_completo', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('id_tramite', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_seguimiento_etapas_id_tramite_search', 'id_tramite', 'id_tramite', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nombre', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_seguimiento_etapas_id_etapa_search', 'id_etapa', 'nombre', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nombre', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_seguimiento_etapas_id_estado_search', 'id_estado', 'nombre', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('id_tramite', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_seguimiento_etapas_id_tramite_search', 'id_tramite', 'id_tramite', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nombre', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_seguimiento_etapas_id_etapa_search', 'id_etapa', 'nombre', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nombre', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_seguimiento_etapas_id_estado_search', 'id_estado', 'nombre', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    try
    {
        $Page = new seguimiento_etapasPage("seguimiento_etapas", "seguimiento_etapas.php", GetCurrentUserPermissionsForPage("seguimiento_etapas"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("seguimiento_etapas"));
